...
parser.add_argument('--model_path', type=str, default='/home/ygx/molecules/molecules/variational_autoencoder/save_points/kl_bce_latent3_mnist/',
...
parser.add_argument('--latent_save_path', type=str, 
                    default='/home/ygx/molecules/molecules/variational_autoencoder/generate_latent/mnist_latent3_epoch90/', 
                    help='path to save generated latent dimensions')
parser.add_argument('--recon_save_path', type=str, 
                    default='/home/ygx/molecules/molecules/variational_autoencoder/generate_recon/mnist_fc_epoch90/', 
